import{t as ye,d as $e,f as we,i as xe,j as Ie,v as je,u as Se,o as ae,_ as S,M as Fe,m as He,h as Ue,e as ze,g as We,a as Xe,b as _e,s as qe}from"./api-viewer-tabs.MrLLxg6f.js";import{i as ce}from"./reactive-element.CHpx6ykd.js";import{e as ue,i as pe,D as Ve,A as de,x,t as Ne,T as Re,s as Pe,n as N}from"./property.DRFXEFyz.js";const Y=[],Ze=(n,e)=>{Y[n]=e},I=Object.freeze({HOST:"host",KNOB:"knob",SLOT:"slot",PREFIX:"prefix",SUFFIX:"suffix",WRAPPER:"wrapper"}),B=n=>n instanceof HTMLTemplateElement,fe=(n,e)=>t=>{const{element:s,target:r}=t.dataset;return s===n&&r===e},J=n=>B(n)?n.content.firstElementChild:null,W=(n,e,t)=>Y[n].find(fe(e,t)),Ge=(n,e,t)=>Y[n].filter(fe(e,t)),re=(n,e,t)=>Y[n].some(fe(e,t));/**
 * @license
